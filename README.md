...
The problem asked to create a function that accepts two strings, first and last name, following the requirements: all letters are in lowercase, the first and last name are joined by a period, and spaces are removed.
